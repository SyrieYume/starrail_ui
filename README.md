...
- 开发基于的QQ版本为 **9.9.11-24815**（目前官网最新版，但是QQ可能会推送更高的版本给部分用户更新），如果遇到问题，可以先尝试更新到该版本。
...
4. 如果在使用过程中遇到Bug，界面有问题（请先自行排查是不是其它插件引起的），或者对本插件有什么改进建议，欢迎在 **[Issues](https://github.com/SyrieYume/starrail_ui/issues)** 提出。
